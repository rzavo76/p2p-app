...
public class FileParserTest
{
    ...
    public void parsesConfigFile()
    {
        try
        {
            ...
            Assert.assertEquals("mein_kampf.dat", fileParser.getFileName());
            Assert.assertEquals(2022984, fileParser.getFileSize());
            Assert.assertEquals(5000, fileParser.getPieceSize());
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public void parsesPeerFile()
    {
        ...
        targetPeers.add(new RemotePeerInfo(1001, "lin114-00.cise.ufl.edu", 5679, true));
        targetPeers.add(new RemotePeerInfo(1002, "lin114-01.cise.ufl.edu", 5679, false));
        targetPeers.add(new RemotePeerInfo(1003, "lin114-02.cise.ufl.edu", 5679, false));
        targetPeers.add(new RemotePeerInfo(1004, "lin114-03.cise.ufl.edu", 5679, false));
        targetPeers.add(new RemotePeerInfo(1005, "lin114-04.cise.ufl.edu", 5679, false));
        targetPeers.add(new RemotePeerInfo(1006, "lin114-05.cise.ufl.edu", 5679, false));
        try
        {
